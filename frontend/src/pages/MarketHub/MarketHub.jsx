  ...
  return (
    <div className="min-h-screen gradient-bg pt-24 pb-16">
      <div className="container-custom px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100/60 text-blue-600 text-sm font-semibold mb-4">
            <TrendingUp className="w-4 h-4" /> Market Intelligence
          </motion.div>
          <motion.h1 variants={fadeUp} className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
            {t('marketHub.title')}
          </motion.h1>
        ...
        >
          <div className="inline-flex bg-white rounded-2xl p-1.5 shadow-card">
            {tabs.map((tab) => (
              <button
                key={tab.key}
